...
public static class CustomerTradePatch {
    [HarmonyPostfix]
    private static void Postfix(CustomerTradeCardScreen instance, CustomerTradeData customerTradeData) {
        // Trading uses cards instead of a price, this patch is specifically for prices.
        if (instance.m_IsTrading) return;
        ...
        var price = instance.m_SellCardAskPrice;
        ...
        instance.OnInputTextUpdated(input);
    }
}